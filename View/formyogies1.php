...
<head>
  ...
  <link
    ...
    rel="stylesheet" />
  <link rel="stylesheet" href="/styles/style_form_yogies.css" />
</head>
    ...
    <div>
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div>
          ...
          <!-- <a href="/View/formyogies2.php"><input type="submit" name="submit" value="Join us and discover our classes near you"></a> -->

          <a href="/View/formyogies2.php">Join us and discover our classes near you</a>
        </div>
        </div>
      </form>
